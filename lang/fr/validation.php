...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute indiqué est apparu dans une fuite de données. Merci de choisir un autre :attribute.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Noms lisibles pour les champs métier du projet GestSoutenance, afin
    | que les messages d'erreur restent compréhensibles côté Frontend.
    |
    */
    ...
    'attributes' => [
        ...
        'directeur_id' => 'directeur de mémoire',
        'titre' => 'titre',
        'filiere' => 'filière',
        'type' => 'type',
        'date' => 'date',
