    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
        <form action="{{ route('admin.salles.update', $salle) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="localisation" id="localisation" value="{{ old('localisation', $salle->localisation) }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="equipements" id="equipements" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('equipements') border-red-500 @enderror">{{ old('equipements', $salle->equipements) }}</textarea>
                @error('equipements')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                <div class="flex items-center">
                    <input type="checkbox" name="actif" id="actif" value="1" {{ old('actif', $salle->actif) ? 'checked' : '' }}
