...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold">Planifier une soutenance</h1>
    </div>

    <div class="bg-white rounded-lg shadow p-6 max-w-3xl">
        <form action="{{ route('secretaire.soutenances.store') }}" method="POST">
            @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="directeur_id" id="directeur_id"
                        ...
                        @foreach($enseignants as $enseignant)
                            <option value="{{ $enseignant->id }}" {{ old('directeur_id') == $enseignant->id ? 'selected' : '' }}>
