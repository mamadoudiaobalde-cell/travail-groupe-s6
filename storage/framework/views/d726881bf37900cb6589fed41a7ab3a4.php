        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-xl font-bold text-gray-800 hover:text-gray-600">
                        <i class="fas fa-graduation-cap text-blue-600"></i> GestSoutenance
                    </a>
                </div>
...
</nav><?php /**PATH C:\Users\hp\Desktop\soutenances\travail-groupe-s6\travail-groupe-s6\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>